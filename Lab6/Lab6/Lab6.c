...
int main()
{
	...
	const char firstName[] = "Артем";
	const char lastName[] = "Парий";
	const char middleName[] = "Игоревич";
	const char number[] = "1БИК17034";
	...
	initCreditSubject(&subjects[0], "Иностранный язык", "Мальцева", 1, 28, 12, 2017);
